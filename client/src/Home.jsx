...
function Home() {
     ...
     *   - Subscribes to the "account" channel to receive friend-related events.
     *   - Updates friend list, pending requests, and friend code on `friendsUpdate`.
     *   - Fetches initial friend data and the user's friend code.
