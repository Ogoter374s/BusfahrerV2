/**
 * @fileoverview NextPlayerButton component for advancing to the next player in the game.
 * <br><br>
 * This component renders a button that allows advancing to the next player in the game. <br>
...
/**
 * A button that allows advancing to the next player in the game. <br>
 * It includes sound effects and visual feedback based on its clickable state.
 * <br><br>
 ...
 * @returns {JSX.Element} The rendered NextPlayerButton component.
 */
function NextPlayerButton({ lobbyId, canClick }) {
    let imgUrl = '/icons/next.svg';
    ...
    /**
     * Handles the click event on the NextPlayerButton.
